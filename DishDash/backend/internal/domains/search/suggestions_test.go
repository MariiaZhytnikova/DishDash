...
func TestSuggestRecipes_Basic(t *testing.T) {
	...
	suggestions := search.SuggestRecipes(recipes, fridge, favs, "")
...
func TestSuggestRecipes_Empty(t *testing.T) {
	res := search.SuggestRecipes([]models.Recipe{}, []models.Ingredient{}, []models.Favorite{}, "")
	if len(res) != 0 {
...
func TestSuggestRecipes_WithQuery(t *testing.T) {
	...
	suggestions := search.SuggestRecipes(recipes, fridge, favs, query)
